...
$Vulnerability = $Request.query["Vulnerability"]



# graphAPI Get users properties
$apiUrl = "https://graph.microsoft.com/beta/security/threatIntelligence/vulnerabilities/$Vulnerability/components?$count=true"
